...
type PNInputValue = string | PersonNameComponents | PersonNameComponents[] | undefined;
 ...
 */
function pnStringToObject(value: PNInputValue, multiple?: true): PersonNameComponents[];
function pnStringToObject(value: PNInputValue, multiple: false): PersonNameComponents | undefined;
 ...
 */
function pnAddValueAccessors<T extends object>(value: T): T & ValueWithAccessors {
        ...
        Object.defineProperty(valueWithAccessors, "toJSON", {
            value: function (this: T) {
                if (Array.isArray(this)) {
                    return this.filter(Boolean).map((x) => pnStringToObject(x as PNInputValue, false));
                } else {
