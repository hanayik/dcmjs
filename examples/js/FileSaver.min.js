    ...
    (function (r) {
        ...
        if ("undefined" == typeof navigator || !/MSIE [1-9]\./.test(navigator.userAgent)) {
            var e = r.document,
                ...
                u = function (r) {
                    return /^\s*(?:text\/\S*|application\/xml|\S*\/\S*\+xml)\s*;.*charset\s*=\s*utf-8/i.test(r.type)
                            ...
                            if (l && i && "undefined" != typeof FileReader) {
                                ...
                                return (
                                    (t.onloadend = function () {
                                        var r = t.result;
                                        (l.location.href = "data:attachment/file" + r.slice(r.search(/[,;]/))),
                                            (p.readyState = p.DONE),
                                            x();
                                    }),
                                    t.readAsDataURL(e),
                    ...
                    return (
                        ...
                        f
                            ...
                            : (r.chrome &&
                                  w &&
                                  w !== m &&
                                  ((v = e.slice || e.webkitSlice), (e = v.call(e, 0, e.size, m)), (y = !0)),
